    ...
    rollNumDaq.prototype = {
        ...
        initHtml: function(obj,options){
			...
			strHtml += '<li class="dataOne ">'+
						'<div class="dataBoc">'+
						'<div class="tt" t="38">'+
						'<span class="num0">H</span>'+'</div></div></li>';
			strHtml += '<li class="dataOne ">'+
						'<div class="dataBoc">'+
						'<div class="tt" t="38">'+
						'<span class="num0">Y</span>'+'</div></div></li>';

			strHtml += '<li class="dataOne ">'+
						'<div class="dataBoc">'+
						'<div class="tt" t="38">'+
						'<span class="num0">0</span>'+'</div></div></li>';
        ...
        scroNum: function(options){
            ...
            $num_item.css('transition','all 4s ease-in-out');

			var $last_num_item = $('.' + options.className).find('.tt:last')
			 $last_num_item.css('transition','all 19s ease-in-out');
